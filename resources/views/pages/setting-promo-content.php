                                                    ...
                                                    <div class="color_picker">
                                                        ...
                                                        <div style="padding: 4px 0px 2px;">
                                                            <div class="color_full_box">
                                                                <input type="text" id="color18_hex"
                                                                    class="for_color_box">
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                <div class="">
                                                    ...
                                                    <div class="Polaris-Connected1">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="setting_promo_text_"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption setting_promo_text_">Left</span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                                        </span>
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                <div class="">
                                                    <div class="color_picker">
                                                        ...
                                                        <div style="padding: 4px 0px 2px;">
                                                            <div class="color_full_box">
                                                                <input type="text" id="color19_hex"
                                                                    class="for_color_box">
                                        ...
                                        <div class="Polaris-FormLayout__Items custome_block">
                                            <div class="Polaris-FormLayout__Item">
                                                <div class="">
                                                    ...
                                                    <div class="Polaris-Connected1">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="promo_text_change"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="Left">Left</option>
                                                                <option value="Center">Center</option>
                                                                <option value="Right">Right</option>
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption promo_text_change">Left</span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                                        </span>
                                        ...
                                        <div class="Polaris-FormLayout__Items">
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="promo_font_size_box"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="10 px">10 px</option>
                                                                <option value="20 px">20 px</option>
                                                                <option value="21 px">21 px</option>
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption promo_font_size_box">10
                                                                    px</span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom: 10px;">
                                                    <div class="">
                                                        <div class="color_picker">
                                                            ...
                                                            <div style="padding: 4px 0px 2px;">
                                                                <div class="color_full_box">
                                                                    <input type="text" id="color20_hex"
                                                                        class="for_color_box">
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="Polaris-Connected1">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="promo_text_change_1"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="Left">Left</option>
                                                                <option value="Center">Center</option>
                                                                <option value="Right">Right</option>
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption promo_text_change_1">Left</span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                                        </span>
                                        ...
                                        <div class="Polaris-FormLayout__Items">
                                            <div class="Polaris-FormLayout__Item">
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="saving_font_name"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="Arial">Arial</option>
                                                                <option value="Roboto">Roboto</option>
                                                                <option value="Popins">Popins</option>
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption saving_font_name">Roboto
                                                                </span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                ...
                                                <div class="spaceing_manage_block">
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="saving_font_size"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="10  px">10 px</option>
                                                                <option value="20  px">20 px</option>
                                                                <option value="30  px">30 px</option>
                                                            </select>
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption saving_font_size">10
                                                                    px
                                                                </span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                ...
                                                <div class="spaceing_manage_block">
                                                    <div class="">
                                                        <div class="color_picker">
                                                            ...
                                                            <div style="padding: 4px 0px 2px;">
                                                                <div class="color_full_box">
                                                                    <input type="text" id="color21_hex"
                                                                        class="for_color_box">
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                ...
                                                <div class="spaceing_manage_block">
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="copy_font_name"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="Arial">Arial</option>
                                                                <option value="Roboto">Roboto</option>
                                                                <option value="Popins">Popins</option>
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption copy_font_name">Roboto
                                                                </span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                ...
                                                <div class="spaceing_manage_block">
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="copy_font_size_name"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="10  px">10 px</option>
                                                                <option value="20  px">20 px</option>
                                                                <option value="30  px">30 px</option>
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption copy_font_size_name">10
                                                                    px
                                                                </span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                <div class="">
                                                    ...
                                                    <div class="Polaris-Connected">
                                                        <div>
                                                            <label>
                                                                <input type="radio" id="percentage_symbol"
                                                                    name="fav_language">
                                                                <label for="percentage_symbol"></label>
                                                                <label>%
                                                                    <input type="radio" id="dollar_symbol"
                                                                        name="fav_language">
                                                                ...
                                                                <label>
                                                                    <input type="radio" id="symbol_none"
                                                                        name="fav_language">
                                                                    <label for="symbol_none">None</label>
                                                                </label>
                                                            </label>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="Polaris-FormLayout__Item">
                                                                    <div class="">
                                                                        <div>
                                                                            ...
                                                                            <div>
                                                                                <label>
                                                                                    <input type="radio" id="all_product"
                                                                                        name="product_radio_btn">
                                                                                    <label for="all_product">All
                                                                                        Product</label>
                                                                                </label>
                                                                            </div>
                                                            ...
                                                            <div class="Polaris-FormLayout__Item">
                                                                <div class="">
                                                                    <div>
                                                                        <div>
                                                                            <label>
                                                                                <input type="radio" id="Free_radiobtn"
                                                                                    name="shippping_radio_btn">
                                                                                <label for="Free_radiobtn">Free</label>
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio_btn_spacing">
                                                                            <label>
                                                                                <input type="radio" id="not_free_radio"
                                                                                    name="shippping_radio_btn">
                                                                                <label for="not_free_radio">Not
                                                                                    Free</label>
                                                                            </label>
                                                                        </div>
                                                                        <div>
                                                                            <label>
                                                                                <input type="radio" id="Flate_rate"
                                                                                    name="shippping_radio_btn">
                                                                                <label for="Flate_rate">Flat
                                                                                    Rate</label>
                                                                            </label>
                                                                        </div>
                                                            ...
                                                            <div class="Polaris-FormLayout__Items">
                                                                <div class="Polaris-FormLayout__Item">
                                                                    <div class="">
                                                                        <div>
                                                                            <label>
                                                                                <input type="radio" id="Exclude_radio"
                                                                                    name="product_radio_btn">
                                                                                <label for="Exclude_radio">Yes</label>
                                                                            </label>
                                                                            <label>
                                                                                <input type="radio" id="include_radio"
                                                                                    name="product_radio_btn">
                                                                                <label for="include_radio">No</label>
                                                                            </label>
                                        ...
                                        <div class="Polaris-FormLayout__Items">
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                <div class="spaceing_manage_block" style="margin-bottom:0px">
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption product_font_name">Roboto
                                                                </span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom:0px">
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="free_product_section"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                                <option selected="" value="10  px">10 px
                                                                </option>
                                                                <option value="20  px">20 px</option>
                                                                <option value="30  px">30 px</option>
                                                            </select>
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption free_product_section">10
                                                                    px
                                                                </span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom:0px">
                                                    <div class="">
                                                        <div class="color_picker">
                                                            ...
                                                            <div style="padding: 4px 0px 2px;">
                                                                <div class="color_full_box">
                                                                    <input type="text" id="color22_hex"
                                                                        class="for_color_box">
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom:0px">
                                                    ...
                                                    <div class="Polaris-Connected1">
                                                        <div class="Polaris-Select">
                                                            <select name="radiusunit" id="product_direction"
                                                                class="Polaris-Select__Input" aria-invalid="false">
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span
                                                                    class="Polaris-Select__SelectedOption product_direction">Left</span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden">
                                                                        </span>
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                <div class="">
                                                    <div class="Polaris-Labelled__LabelWrapper">
                                                        <div class="Polaris-Label">
                                                            <label id="PolarisTextField1Label" for="PolarisTextField1"
                                                                class="Polaris-Label__Text">Google Spreadsheet
                                                                ID
                                                                (name)</label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="forms_section_layouts" style="    align-items: self-end;">
                                        <div class="forms_img_preview_option copoon_code">
                                            <div class="feed_back">
                                                ...
                                                <p>We have received your submission and want to reward you with
                                                    a
                                                    discount on
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        <p>if you have any question please email us
                                                            <span>info@atjittergit.com</span> Please allow
                                                            between 4 to
                                                            5 business days to recieve the voucher on the email
                                                            you
                                                            provide us
