<div class="Polaris-Frame__Content" style="padding:5px 15px">
    <div class="Polaris-Page view_page">
        ...
        $('.colorpickerbox').each(function() {
            ...
            let colorpicker1 = document.getElementById(
                colorpicker);
            setInterval(() => {
                let color = colorpicker1.value;
                $("#" + colorpicker + "_hex").val(
                    color);
            }, 200);
        });
        </script>