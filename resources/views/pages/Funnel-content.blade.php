            ...
            <div>
                <div class="pagination_active_section">
                    <ul>
                        ...
                        <li class="active_pagination"><a href="Funnel">1</a></li>
                        ...
                        <li style="margin:0px"><a href="marketplace.php"><span class="Polaris-Button__Content">
                                    <span class="Polaris-Button__Icon">
                                        <span class="Polaris-Icon">
                                            <span class="Polaris-Text--root Polaris-Text--visuallyHidden">
                                            </span>
            ...
            <div class="save_nd_publish_mode">
                <div class="enbaled_text">
                    ...
                    <!-- <label class="switch" for="checkbox_">
                        <input type="checkbox" name="status" id="checkbox_" value="true">
                        <div class="slider round"></div>
                    </label> -->

                     <label class="switch" for="checkbox_">
                        <input type="checkbox" name="status" id="checkbox_" {{ $data ? 'checked' : '' }}>
                        <div class="slider round"></div>
                    </label>
                        ...
                        <div class="Polaris-Card">
                            <div class="Polaris-Card__Section">
                                ...
                                <div class="bramnds_block">
                                    <h4>Class</h4>
                                    <p>Drag and Drop to place Class in order</p>
                                </div>
                                    ...
                                    <ul class="connected-sortable droppable-area1" style="margin-bottom:10px">
                                        <li class="draggable-item">
                                            <div class="brands_slide_img">
                                                <img src="images/DINOMANIACS LOGO 1@0.5x.png">
                                            </div>
                                        </li>
                                        <li class="active_brands draggable-item">
                                            <div class="brands_slide_img">
                                                <img src="images/ROBOTRYX LOGO SIMPLE.png">
                                            </div>
                                        </li>
                                        <li class="draggable-item">
                                            <div class="brands_slide_img">
                                                ...
                                                <div class="Polaris-Labelled--hidden">
                                                    ...
                                                    <div class="Polaris-Labelled__LabelWrapper">
                                                        <div class="Polaris-Label">
                                                            ...
                                                            <input type="file" name="backeground_images"  class="image-upload" accept="image/*">
                                                            @if(isset($data->image))
                                        ...
                                        <div>
                                            <div class="js--image-preview">
                                                <div class="thumbnails_img">
                                                    @if($data && $data->backeground_images)
                                                        <img width="134" height="104" src="{{ asset('Imges/background/' . $data->backeground_images) }}">
                                                    @else
                                                    ...
                                                    <div class="Polaris-Connected">
                                                        <div
                                                            ...
                                                            <div class="Polaris-TextField">
                                                                <input id="PolarisTextField1" name="title" autocomplete="email"
                                                                    ...
                                                                    aria-invalid="false"  placeholder="hello" value="{{ $data->title ?? old('title') }}" required>
                                            ...
                                            <div class="Polaris-FormLayout__Items">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="Polaris-Connected1">
                                                            <div class="Polaris-Select">
                                                                <select name="font_name" id="market_font_name" class="Polaris-Select__Input" aria-invalid="false">
                                                                ...
                                                                <div class="Polaris-Select__Content" aria-hidden="true">
                                                                    <span
                                                                        class="Polaris-Select__SelectedOption market_font_name">{{$data->font_name ??  ''}}</span>
                                                                ...
                                                                <div style="padding: 4px 0px 2px;">
                                                                    <div class="color_full_box">
                                                                        <input type="text" id="color2_hex"
                                                                            class="for_color_box" name="font_color" value="{{$data->font_color ??  ''}}">
                                                                        <input type="color" id="color2"
                                                                            class="color_picker_box colorpickerbox"
                                                                            name="font_color"  value="{{$data->font_color ??  ''}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="upload-options">
                                                                <label>
                                                                    <div class="Polaris-Labelled--hidden">
                                                                        <div class="Polaris-Labelled__LabelWrapper">
                                                                            <div class="Polaris-Label">
                                                                                <input type="file" name="logo_image" class="image-upload"
                                                                                    accept="image/*">
                                                                            </div>
                                                                        </div>
                                                                        <div class="Polaris-DropZone Polaris-DropZone--hasOutline Polaris-DropZone--sizeMedium"
                                                            ...
                                                            <div>
                                                                <div class="js--image-preview">
                                                                    ...
                                                                    @if($data && $data->logo_image)
                                                                        <img width="134" height="104" src="{{ asset('Imges/logo/' . $data->logo_image) }}">
                                                                    @else
                                                                        <img src="images/img_thumbanail.svg">
                                                                    @endif
                                                ...
                                                <div class="Polaris-FormLayout__Item">
                                                    <div class="">
                                                        ...
                                                        <div class="Polaris-Connected1">
                                                            <div class="Polaris-Select">
                                                            <select name="font_size" id="market_font_sizie" class="Polaris-Select__Input" aria-invalid="false">
                                                                ...
                                                                <div class="Polaris-Select__Content" aria-hidden="true">
                                                                    <span
                                                                        class="Polaris-Select__SelectedOption market_font_sizie">{{$data->font_size ??  ''}}</span>
                                                                    <span class="Polaris-Select__Icon">
                                                                        <span class="Polaris-Icon">
                                                                            <span class="Polaris-VisuallyHidden">
                                                                            </span>
                                                    ...
                                                    <div class="spaceing_manage_block">
                                                        ...
                                                        <div class="Polaris-Connected1">
                                                            <div class="Polaris-Select">
                                                            <select name="text_orientation" id="market_text_direction" class="Polaris-Select__Input" aria-invalid="false">
                                                                ...
                                                                <div class="Polaris-Select__Content" aria-hidden="true">
                                                                    <span
                                                                        class="Polaris-Select__SelectedOption market_text_direction">{{$data->text_orientation ??  ''}}</span>
                                                                    <span class="Polaris-Select__Icon">
                                                                        <span class="Polaris-Icon">
                                                                            <span class="Polaris-VisuallyHidden">
                                                                            </span>
                                                    ...
                                                    <div class="spaceing_manage_block">
                                                        <div class="Polaris-Labelled__LabelWrapper">
                                                            <div class="Polaris-Label">
                                                                <label id="PolarisTextField2Label"
                                                                    for="PolarisTextField2"
                                                                    class="Polaris-Label__Text">Additional
                                                                    Modules / Add Section</label>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="Polaris-TextField">
                                                                            <input id="PolarisTextField1"
                                                                                ...
                                                                                type="text" name="radiusunit" 
                                                                                aria-labelledby="PolarisTextField1Label"
                                                                                aria-invalid="false"  value="{{$data->radiusunit ??  ''}}">
                                                            ...
                                                            <div class="">
                                                                <div class="details_section border_site_toggle">
                                                                    ...
                                                                    <label class="switch" for="checkbox_1">
                                                                        <input type="checkbox" id="checkbox_1" name="borders"  {{ $data ? 'checked' : '' }}>
                                                                        <div class="slider round"></div>
                                                                    </label>
                                                                ...
                                                                <div class="Polaris-Connected">
                                                                    <div
                                                                        class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                                        <div class="Polaris-TextField">
                                                                            <input id="PolarisTextField2" name="radiusunits"
                                                                                autocomplete="off"
                                                                                class="Polaris-TextField__Input"
                                                                                type="text"
                                                                                aria-labelledby="PolarisTextField2Label"
                                                                                aria-invalid="false"  value="{{$data->radiusunits ??  ''}}">
                                                                            <div class="Polaris-TextField__Spinner"
                                                                                aria-hidden="true">
                                                                            </div>
                                                                            <div class="Polaris-TextField__Backdrop">
                                                        ...
                                                        <div class="Polaris-FormLayout__Item">
                                                            <div class="">
                                                                <div class="color_picker">
                                                                    ...
                                                                    <div style="padding: 4px 0px 2px;">
                                                                        <div class="color_full_box">
                                                                            <input type="text" id="color1_hex"
                                                                                class="for_color_box" name="color_tile"  value="{{$data->color_tile ??  ''}}">
                                                                            <input type="color" id="color1"
                                                                                class="color_picker_box colorpickerbox"
                                                                                value="{{$data->color_tile ??  ''}}" name="color_tile">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div style="padding: 4px 0px 2px;">
                                                                        <div class="color_full_box">
                                                                            <input type="text" id="color_hex"
                                                                                class="for_color_box" name="color_tiles"  value="{{$data->color_tiles ??  ''}}">
                                                                            <input type="color" id="color"
                                                                                class="color_picker_box colorpickerbox"
                                                                                value="{{$data->color_tiles ??  ''}}" name="color_tiles" >
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="range_slider_dobule">
                                                                <div class="wrapper">
                                                                    <div class="container">
                                                                        ...
                                                                        <input type="range" min="0" max="100"  value="{{$data->opacity1 ??  ''}}"
                                                                            id="slider-1" oninput="slideOne()" name="opacity1">
                                                                        <input type="range" min="0" max="100"  value="{{$data->opacity ??  ''}}"
                                                                            id="slider-2" oninput="slideTwo()" name="opacity">
                                                                    </div>
                                                                    <div class="values">
                                                                        <span id="range1">
                                                                            0
                                                            ...
                                                            <div class="img_upload_texture">
                                                                <div class="rounded_btn_block">
                                                                    ...
                                                                    <label class="switch" for="checkbox_4">
                                                                        <input type="checkbox" id="checkbox_4" name="texton" {{ $data ? 'checked' : '' }} >
                                                                        <div class="slider round"></div>
                                                                    </label>
                                                                </div>
                                                                <div class="wrapper">
                                                                    <div class="box add_promotion_box">
                                                                            ...
                                                                            <label>
                                                                                <div class="Polaris-Labelled--hidden">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="Polaris-Label">
                                                                                            <input type="file" name="text_images"
                                                                                                class="image-upload"
                                                                                                accept="image/*">
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div>
                                                                            <div class="js--image-preview">
                                                                                <div class="thumbnails_img">
                                                                                @if($data && $data->text_images)
                                                                                    <img width="134" height="104" src="{{ asset('Imges/text_images/' . $data->text_images) }}">
                                                                                @else
                                                                                    <img src="images/img_thumbanail.svg">
                                                                                @endif
                                                    ...
                                                    <div class="Polaris-Connected">
                                                        <div
                                                            ...
                                                            <div class="Polaris-TextField Add_custom_polaris">
                                                                <input id="PolarisTextField1" autocomplete="off" name="tile_height"
                                                                    class="Polaris-TextField__Input" type="text"
                                                                    aria-labelledby="PolarisTextField1Label"
                                                                    aria-invalid="false"  value="{{$data->tile_height ??  ''}}">
                                                                <div class="Polaris-TextField__Backdrop">
                                                                </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="">
                                                        <div class="color_picker">
                                                            ...
                                                            <div style="padding: 4px 0px 2px;">
                                                                <div class="color_full_box">
                                                                    <input type="text" id="color3_hex"
                                                                        class="for_color_box" name="tile_color"  value="{{$data->tile_color ??  ''}}">
                                                                    <input type="color" id="color3"
                                                                        class="color_picker_box colorpickerbox"
                                                                        value="{{$data->tile_color ??  ''}}" name="tile_color" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="Polaris-FormLayout__Item">
                                                <div class="spaceing_manage_block">
                                                    ...
                                                    <div class="Polaris-Connected">
                                                        <div
                                                            class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                            <div class="Polaris-TextField Add_custom_polaris">
                                                                <input id="PolarisTextField1" autocomplete="off" name="tile_width"
                                                                    class="Polaris-TextField__Input" type="text"
                                                                    aria-labelledby="PolarisTextField1Label"
                                                                    aria-invalid="false"  value="{{$data->tile_width ??  ''}}">
                                                                <div class="Polaris-TextField__Backdrop">
                                                                </div>
                                                                <div class="manage_dimension_pixel">
                                                                    <p>
                                                ...
                                                <div class="spaceing_manage_block ">
                                                    ...
                                                    <div class="range-slider1" style="margin-bottom:10px">
                                                        <div id="tooltip"></div>
                                                        <input id="range" type="range" step="10"  value="{{$data->range ??  ''}}" min="0"
                                                            max="100" name="range">
                                                    </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="Polaris-TextField">
                                                                <input id="PolarisTextField1" autocomplete="off"
                                                                    class="Polaris-TextField__Input" type="text"
                                                                    aria-labelledby="PolarisTextField1Label"
                                                                    aria-invalid="false"  value="{{$data->text_hover ??  ''}}" name="text_hover">
                                                                <div class="Polaris-TextField__Backdrop">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="Polaris-Labelled__LabelWrapper">
                                                        <div class="rounded_btn_block">
                                                            ...
                                                            <label class="switch" for="checkbox_3">
                                                                <input type="checkbox" id="checkbox_3" name="text_check"  value="{{$data->text_check ??  ''}}">
                                                                <div class="slider round"></div>
                                                            </label>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="wrapper">
                                                            <div class="box add_promotion_box">
                                                                ...
                                                                <div class="upload-options">
                                                                    <label>
                                                                        <div class="Polaris-Labelled--hidden">
                                                                            <div class="Polaris-Labelled__LabelWrapper">
                                                                                <div class="Polaris-Label">
                                                                                    <input type="file" name="tile_images"
                                                                                        class="image-upload"
                                                                                        accept="image/*">
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div>
                                                                    <div class="js--image-preview">
                                                                        <div class="thumbnails_img">
                                                                        @if($data && $data->tile_images)
                                                                                    <img width="134" height="104" src="{{ asset('Imges/tile_images/' . $data->tile_images) }}">
                                                                                @else
                                                                                    <img src="images/img_thumbanail.svg">
                                                                                @endif
                                    ...
                                    <div class="Polaris-Connected">
                                        <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                            <div
                                                ...
                                                <textarea id="PolarisTextField1" autocomplete="off" name="notes"  value="{{$data->notes ??  ''}}"
                                                    class="Polaris-TextField__Input" type="text" rows="4"
                                                    aria-labelledby="PolarisTextField1Label" aria-invalid="false"
                                                    aria-multiline="true" style="height: 106px;" spellcheck="false" required>{{ $data->notes ?? old('notes') }}</textarea>
                                                ...
                                                <div class="spaceing_manage_block " style="margin-bottom:0px">
                                                    ...
                                                    <div class="Polaris-Connected">
                                                        <div
                                                            class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                            <div class="Polaris-TextField">
                                                                <input id="PolarisTextField1" name="id_name" autocomplete="off"
                                                                    class="Polaris-TextField__Input" type="text"
                                                                    aria-labelledby="PolarisTextField1Label"
                                                                    aria-invalid="false"  value="{{$data->id_name ??  ''}}">
                                                                <div class="Polaris-TextField__Backdrop">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="spaceing_manage_block" style="margin-bottom:0px">
                                                    ...
                                                    <div class="Polaris-Connected">
                                                        <div
                                                            class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                            <div class="Polaris-TextField">
                                                                <input id="PolarisTextField2" name="tab_name" autocomplete="off"
                                                                    class="Polaris-TextField__Input" type="text"
                                                                    aria-labelledby="PolarisTextField2Label"
                                                                    aria-invalid="false"  value="{{$data->tab_name ??  ''}}">
                                                                <div class="Polaris-TextField__Backdrop">
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="Polaris-Card">
                            <div class="Polaris-Card__Section">
                                ...
                                <!-- <div class="check_box_section">
                                    <label>
                                        <input type="radio" id="Yes" name="fav_language"  value="{{$data->fav_language ??  ''}}">
                                        <label for="Yes">Yes</label>
                                    </label>
                                    <label>
                                        <input type="radio" id="No" name="fav_language" value="{{$data->fav_language ??  ''}}">
                                ...
                                <div class="check_box_section">
                                    <label>
                                        <input type="radio" id="Yes" name="fav_language" value="Yes" @if(isset($data) && $data->fav_language === 'Yes') checked @endif>
                                        <label for="Yes">Yes</label>
                                    </label>
                                    <label>
                                        <input type="radio" id="No" name="fav_language" value="No" @if(isset($data) && $data->fav_language === 'No') checked @endif>
                                        <label for="No">No</label>
                                    </label>
                                </div>
                        ...
                        <div class="sticky_section_preview">
                            ...
                            <div class="Polaris-Card__Section">
                                <div class="preview_img">
                                    ...
                                    <div class="custome_preview_block">
                                        <ul class="connected-sortable droppable-area2 block_section_drop">
                                            <li class=" draggable-item">
                                                <img
                                                    src="https://jitterygit.com/wp-content/uploads/2020/11/robotryx-logo-winner.png">
                                            </li>
                                            <li class=" draggable-item">
                                                <img
                                                    src="https://jitterygit.com/wp-content/uploads/2020/11/dino-logo-winer.png">
                                            </li>
                                            <li class=" draggable-item">
                                                <img
                                                    src="https://jitterygit.com/wp-content/uploads/2022/11/logo-winners-jg.png">
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="edit_btn_preview">
                                    ...
                                    <!-- <a href="/edit" class="Polaris-Button Polaris-Button--primary">
                                        <span class="Polaris-Button__Text">Edit</span>
                                    </a>
                                </div> -->
                    ...
                    <div class="Polaris-FooterHelp__Text">Learn more about <a target="_blank" class="Polaris-Link"
                            ...
                            data-polaris-unstyled="true">fulfilling orders<span class="Polaris-Link__IconLockup"><span
                                    class="Polaris-Link__IconLayout"><span class="Polaris-Icon"><span
                                            class="Polaris-VisuallyHidden">(opens a new
                                            window)</span><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg"
                                            focusable="false" aria-hidden="true">
                                            <path
...
<!-- slider-js---tooltip--slider---start -->
...
<!-- slider-js---tooltip--slider---end -->


<!-- slider--js----first-page--start -->
<script>
...
<!-- slider--js----first-page--end -->
<!-- drag--and-drop--js--start--js -->
<script>
$(init);
function init() {
